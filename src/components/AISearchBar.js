...
const AISearchBar = () => {
  ...
  const handleAISearchClick = async () => {
    ...
    - "movieName" (optional):  The name of the movie if user mentioned else return default here. Default is "".
    ...
    So dont add any text or content other than the above mention javascript stringified json.
  ...
  return (
    <div className="w-full py-2 px-10">
      <form
        className="py-3 px-4 w-full rounded-xl flex gap-3 bg-gradient-to-tr from-primary to-black"
